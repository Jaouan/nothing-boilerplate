...
export const PillButton = ({ className, ...props }: PillButtonProps) => (
	<Button
		className={cn(
			"-my-2 -mr-2 size-6 rounded-md p-0.5 hover:bg-foreground/5",
			className,
		)}
		size="icon"
		variant="ghost"
...
export const PillIndicator = ({
	...
	<span className="relative flex size-2">
		{pulse && (
			<span
				className={cn(
					"absolute inline-flex h-full w-full animate-ping rounded-md opacity-75",
		...
		<span
			className={cn(
				"relative inline-flex size-2 rounded-md",
