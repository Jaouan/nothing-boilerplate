/** biome-ignore-all lint/suspicious/noExplicitAny: open registry */
"use client";
	...
	({
		...
		return (
			...
			>
				{fadeOut && (
					<>
						<div
							aria-hidden
							className={cx(
								"md:hidden pointer-events-none absolute inset-y-0 left-0 z-1",
				...
				<div
					className={cx(
						"flex justify-center items-center w-max will-change-transform select-none",
